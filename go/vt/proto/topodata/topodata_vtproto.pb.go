...
func (m *Keyspace) CloneVT() *Keyspace {
	...
	r.IsVirtual = m.IsVirtual
	r.VirtualKeyspaceInfo = m.VirtualKeyspaceInfo.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *VirtualKeyspaceInfo) CloneVT() *VirtualKeyspaceInfo {
	if m == nil {
		return (*VirtualKeyspaceInfo)(nil)
	}
	r := new(VirtualKeyspaceInfo)
...
func (m *VirtualKeyspaceInfo) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *VirtualKeyspace) CloneVT() *VirtualKeyspace {
	if m == nil {
		return (*VirtualKeyspace)(nil)
	}
	r := new(VirtualKeyspace)
	r.Name = m.Name
	r.PhysicalKeyspace = m.PhysicalKeyspace
	r.SchemaName = m.SchemaName
	r.CreatedAt = m.CreatedAt.CloneVT()
...
func (m *VirtualKeyspace) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *VirtualTabletRegistration) CloneVT() *VirtualTabletRegistration {
	if m == nil {
		return (*VirtualTabletRegistration)(nil)
	}
	r := new(VirtualTabletRegistration)
	r.PhysicalKeyspace = m.PhysicalKeyspace
	r.MaxAssignments = m.MaxAssignments
	r.RegisteredAt = m.RegisteredAt.CloneVT()
...
func (m *VirtualTabletRegistration) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Keyspace) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.VirtualKeyspaceInfo != nil {
		size, err := m.VirtualKeyspaceInfo.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *VirtualKeyspaceInfo) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *VirtualKeyspaceInfo) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *VirtualKeyspaceInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *VirtualKeyspace) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *VirtualKeyspace) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *VirtualKeyspace) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *VirtualTabletRegistration) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *VirtualTabletRegistration) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *VirtualTabletRegistration) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.RegisteredAt != nil {
		size, err := m.RegisteredAt.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if len(m.VirtualKeyspaces) > 0 {
		for iNdEx := len(m.VirtualKeyspaces) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.VirtualKeyspaces[iNdEx])
			copy(dAtA[i:], m.VirtualKeyspaces[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.VirtualKeyspaces[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if m.MaxAssignments != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.MaxAssignments))
		i--
		dAtA[i] = 0x10
	}
	if len(m.PhysicalKeyspace) > 0 {
...
func (m *Keyspace) SizeVT() (n int) {
	...
	if m.VirtualKeyspaceInfo != nil {
		l = m.VirtualKeyspaceInfo.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *VirtualKeyspaceInfo) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VirtualKeyspace) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VirtualTabletRegistration) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MaxAssignments != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.MaxAssignments))
	}
	if len(m.VirtualKeyspaces) > 0 {
		for _, s := range m.VirtualKeyspaces {
			l = len(s)
			n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
	if m.RegisteredAt != nil {
		l = m.RegisteredAt.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *Keyspace) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VirtualKeyspaceInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VirtualKeyspaceInfo == nil {
				m.VirtualKeyspaceInfo = &VirtualKeyspaceInfo{}
			}
			if err := m.VirtualKeyspaceInfo.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *VirtualKeyspaceInfo) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VirtualKeyspaceInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VirtualKeyspaceInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VirtualKeyspace) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VirtualKeyspace: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VirtualKeyspace: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VirtualTabletRegistration) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VirtualTabletRegistration: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VirtualTabletRegistration: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxAssignments", wireType)
			}
			m.MaxAssignments = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxAssignments |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			m.VirtualKeyspaces = append(m.VirtualKeyspaces, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			if m.RegisteredAt == nil {
				m.RegisteredAt = &vttime.Time{}
			}
			if err := m.RegisteredAt.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
