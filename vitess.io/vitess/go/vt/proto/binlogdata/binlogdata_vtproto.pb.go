...
func (m *BinlogTransaction) CloneVT() *BinlogTransaction {
	...
	if rhs := m.EventToken; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.EventToken }); ok {
			r.EventToken = vtpb.CloneVT()
		} else {
			r.EventToken = proto.Clone(rhs).(*query.EventToken)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *RowChange) CloneVT() *RowChange {
	...
	if rhs := m.Before; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.Row }); ok {
			r.Before = vtpb.CloneVT()
		} else {
			r.Before = proto.Clone(rhs).(*query.Row)
		}
	}
	if rhs := m.After; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.Row }); ok {
			r.After = vtpb.CloneVT()
		} else {
			r.After = proto.Clone(rhs).(*query.Row)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *VStreamRequest) CloneVT() *VStreamRequest {
	...
	if rhs := m.ImmediateCallerId; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.VTGateCallerID }); ok {
			r.ImmediateCallerId = vtpb.CloneVT()
		} else {
			r.ImmediateCallerId = proto.Clone(rhs).(*query.VTGateCallerID)
		}
	}
	if rhs := m.Target; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.Target }); ok {
			r.Target = vtpb.CloneVT()
		} else {
			r.Target = proto.Clone(rhs).(*query.Target)
		}
	}
...
func (m *VStreamRowsRequest) CloneVT() *VStreamRowsRequest {
	...
	if rhs := m.Lastpk; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.QueryResult }); ok {
			r.Lastpk = vtpb.CloneVT()
		} else {
			r.Lastpk = proto.Clone(rhs).(*query.QueryResult)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *VStreamRowsResponse) CloneVT() *VStreamRowsResponse {
	...
	if rhs := m.Rows; rhs != nil {
		...
		for k, v := range rhs {
			if vtpb, ok := interface{}(v).(interface{ CloneVT() *query.Row }); ok {
				tmpContainer[k] = vtpb.CloneVT()
			} else {
				tmpContainer[k] = proto.Clone(v).(*query.Row)
			}
		}
		r.Rows = tmpContainer
	}
	if rhs := m.Lastpk; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *query.Row }); ok {
			...
			r.Lastpk = proto.Clone(rhs).(*query.Row)
		}
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
